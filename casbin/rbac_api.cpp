...
// PHPCPP
Php::Value Enforcer :: getRolesForUser(Php::Parameters &params) {
    string name = params[0];
    vector<string> domain = params[1];
    return this->temp->GetRolesForUser(name, domain);
}
...
// PHPCPP
Php::Value Enforcer :: getUsersForRole(Php::Parameters &params) {
    string name = params[0];
    vector<string> domain = params[1];
    return this->temp->GetUsersForRole(name, domain);
}
...
// PHPCPP
Php::Value Enforcer :: hasRoleForUser(Php::Parameters &params) {
    string name = params[0];
    string role = params[1];
    return this->temp->HasRoleForUser(name, role);
}
...
// PHPCPP
Php::Value Enforcer :: addRoleForUser(Php::Parameters &params) {
    string user = params[0];
    string role = params[1];
    return this->temp->AddRoleForUser(user, role);
}
...
// PHPCPP
Php::Value Enforcer :: addRolesForUser(Php::Parameters &params) {
    string user = params[0];
    vector<string> roles = params[1];
    return this->temp->AddRolesForUser(user, roles);
}
...
// PHPCPP
Php::Value Enforcer :: deleteRoleForUser(Php::Parameters &params) {
    string user = params[0];
    string role = params[1];
    return this->temp->DeleteRoleForUser(user, role);
}
...
// PHPCPP
Php::Value Enforcer :: deleteRolesForUser(Php::Parameters &params) {
    string user = params[0];
    return this->temp->DeleteRolesForUser(user);
}
...
// PHPCPP
Php::Value Enforcer :: deleteUser(Php::Parameters &params) {
    string user = params[0];
    return this->temp->DeleteUser(user);
}
...
// PHPCPP
Php::Value Enforcer :: deleteRole(Php::Parameters &params) {
    string role = params[0];
    return this->temp->DeleteRole(role);
}
...
// PHPCPP
Php::Value Enforcer :: deletePermission(Php::Parameters &params) {
    vector<string> permission = params[0];
    return this->temp->DeletePermission(permission);
}
...
// PHPCPP
Php::Value Enforcer :: addPermissionForUser(Php::Parameters &params) {
    string user = params[0];
    vector<string> permission = params[1];
    return this->temp->AddPermissionForUser(user, permission);
}
...
// PHPCPP
Php::Value Enforcer :: deletePermissionForUser(Php::Parameters &params) {
    string user = params[0];
    vector<string> permission = params[1];
    return this->temp->DeletePermissionForUser(user, permission);
}
...
// PHPCPP
Php::Value Enforcer :: deletePermissionsForUser(Php::Parameters &params) {
    string user = params[0];
    return this->temp->DeletePermissionsForUser(user);
}
...
// PHPCPP
Php::Value Enforcer :: getPermissionsForUser(Php::Parameters &params) {
    string user = params[0];
    return this->temp->GetPermissionsForUser(user);
}
...
// PHPCPP
Php::Value Enforcer :: hasPermissionForUser(Php::Parameters &params) {
    string user = params[0];
    vector<string> permission = params[1];
    return this->temp->HasPermissionForUser(user, permission);
}
...
// PHPCPP
Php::Value Enforcer :: getImplicitRolesForUser(Php::Parameters &params) {
    string name = params[0];
    vector<string> domain = params[1];
    return this->temp->GetImplicitRolesForUser(name, domain);
}
...
// PHPCPP
Php::Value Enforcer :: getImplicitPermissionsForUser(Php::Parameters &params) {
    string user = params[0];
    vector<string> domain = params[1];
    return this->temp->GetImplicitPermissionsForUser(user, domain);
}
...
// PHPCPP
Php::Value Enforcer :: getImplicitUsersForPermission(Php::Parameters &params) {
    vector<string> permission = params[0];
    return this->temp->GetImplicitUsersForPermission(permission);
}

void registerRbacApi(Php::Class<Enforcer> &enforcer)
{
    enforcer.method<&Enforcer::getRolesForUser>("getRolesForUser");
    enforcer.method<&Enforcer::getUsersForRole>("getUsersForRole");
    enforcer.method<&Enforcer::hasRoleForUser>("hasRoleForUser");
    enforcer.method<&Enforcer::addRoleForUser>("addRoleForUser");
    enforcer.method<&Enforcer::addRolesForUser>("addRolesForUser");
    enforcer.method<&Enforcer::addPermissionForUser>("addPermissionForUser");
    enforcer.method<&Enforcer::deletePermissionForUser>("deletePermissionForUser");
    enforcer.method<&Enforcer::deletePermissionsForUser>("deletePermissionsForUser");
    enforcer.method<&Enforcer::getPermissionsForUser>("getPermissionsForUser");
    enforcer.method<&Enforcer::hasPermissionForUser>("hasPermissionForUser");
    enforcer.method<&Enforcer::getImplicitRolesForUser>("getImplicitRolesForUser");
    enforcer.method<&Enforcer::getImplicitPermissionsForUser>("getImplicitPermissionsForUser");
    enforcer.method<&Enforcer::getImplicitUsersForPermission>("getImplicitUsersForPermission");
    enforcer.method<&Enforcer::deleteRoleForUser>("deleteRoleForUser");
    enforcer.method<&Enforcer::deleteRolesForUser>("deleteRolesForUser");
    enforcer.method<&Enforcer::deleteUser>("deleteUser");
    enforcer.method<&Enforcer::deleteRole>("deleteRole");
    enforcer.method<&Enforcer::deletePermission>("deletePermission");
}